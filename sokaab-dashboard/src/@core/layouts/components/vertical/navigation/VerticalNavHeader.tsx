    ...
    <MenuHeaderWrapper className='nav-header' sx={{ pl: menuHeaderPaddingLeft() }}>
      {userNavMenuBranding ? (
        ...
        <LinkStyled href='/'>
          ...
          {/* <CustomAvatar src={'/public/images/logos/sokaab-logo.png'} sx={{ mr: 2.5, width: 38, height: 38 }} /> */}
          <img
            // src='/images/logos/sokaab-logo.png'
            src='/images/logos/sokaab-logo-admin.png'
            style={{ width: '11rem', marginBottom: '1.4rem', marginTop: '0.5rem' }}
            alt=''
          />
        </LinkStyled>
      )}
