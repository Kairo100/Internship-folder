...
//           '&.Mui-focused fieldset': { borderColor: COLORS.highlight }
//         }
//       }}
//     />
//   )
...
//     borderRadius: 8,
//     backgroundColor: 'transparent !important',
//     // Corrected: Ensure theme.palette.customColors is defined, using primary as a fallback or example
//     border: `1px solid rgba(${theme.palette.customColors?.main || theme.palette.primary.main}, 0.2)`,
//     transition: theme.transitions.create(['border-color', 'box-shadow'], {
//       duration: theme.transitions.duration.shorter
//     }),
//     '&:not(.Mui-focused):not(.Mui-disabled):not(.Mui-error):hover': {
//       borderColor: `rgba(${theme.palette.customColors?.main || theme.palette.primary.main}, 0.28)`
//     },
//     '&:before, &:after': {
//       display: 'none'
//     },
...
const TextFieldStyled = styled(TextField)<TextFieldProps>(({ theme }) => ({
  ...
  '& .MuiInputBase-root': {
    borderRadius: 8,
    backgroundColor: 'transparent !important',
    // Fixed border fallback: Use rgba safely with primary.main
    border: `1px solid ${theme.palette.primary.main}33`, // 20% opacity
    transition: theme.transitions.create(['border-color', 'box-shadow'], {
      duration: theme.transitions.duration.shorter
    }),
    '&:not(.Mui-focused):not(.Mui-disabled):not(.Mui-error):hover': {
      borderColor: `${theme.palette.primary.main}45` // slightly darker on hover
    },
  ...
  '& .MuiSelect-filled .MuiChip-root': { height: 22 },
  ...
  '& + .react-datepicker__close-icon': {
    top: 11,
    '&:after': { fontSize: '1.6rem !important' }
  }
}))
