"use client";
import { fetchMovieDetails, fetchTrendingMovies } from "@/utils/api";
...
try {
  ...
  // Optionally, you could return a fallback UI or throw a custom error here
}
  ...
  return (
    ...
    >
      <Link
        ...
        onMouseEnter={(e) => (e.currentTarget.style.color = "#21a1f1")}
